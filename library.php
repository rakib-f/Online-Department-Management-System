                    ...
                    <div class="col-sm-10 col-sm-offset-2">
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            if($book_name!=NULL && $book_author!=NULL && $book_publisher != NULL && $book_edition != NULL && $book_quantity != NULL && $book_borrowed != NULL && $book_available != NULL ){
                                ...
                                $sql = "INSERT INTO `library` (book_name ,book_publisher, book_edition, book_quantity,book_borrowed, book_available) VALUES ('$book_name','$book_author','$book_publisher', '$book_edition', '$book_quantity' , '$book_borrowed', '$book_available')";
                        ...
                        <form action="library.php" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                            <label for="book_publisher" class="col-sm-2 control-label">Publisher name:</label>
                            <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="book_borrowed" placeholder="Enter borrowed book name">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="book_available" class="col-sm-2 control-label">Book Available</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="book_available" placeholder="Enter available book name">
                                </div>
                            </div>
