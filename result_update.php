...
if (isset($_POST['submit'])){
 ...
 //    $individual_result = $_POST['individual_result'];
     ...
     if($name!=NULL && $session!=NULL && $year!=NULL && $semester!=NULL && $roll!=NULL && $total_result!=NULL && $grade!=NULL){
     
     $sql = "UPDATE `result` SET `name`='$name',`session`='$session',`year`='$year',`semester`='$semester',`roll`='$roll',`total_result`='$total_result',`grade`='$grade' WHERE id='$id'";
