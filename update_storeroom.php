...
if (isset($_POST['submit'])){
     ...
     $sql = "UPDATE `store` SET `product_name`='$product_name',`product_supplier`='$product_supplier',`product_quantity`='$product_quantity',`purchase_date`='$purchase_date',`warranty_expiration_date`='$warranty_expiration_date',`status_info`='$status_info' WHERE `product_id`='$id'";
